...
$aLang = [
    ...
    'HELP_DISCOUNT_MAIN_AMOUNT' => 'You can use <span class="navipath_or_inputname">Quantity</span> to specify that the discount is only valid for certain purchase quantities. If you want the discount to be valid for all purchase quantities, enter <span class="userinput_or_code">0</span> in <span class="navipath_or_inputname">From</span> and <span class="userinput_or_code">0</span> in <span class="navipath_or_inputname">To</span>. <br><br>The value entered in <span class="navipath_or_inputname">From</span> also controls where the discount is displayed: <span class="userinput_or_code">0</span> - The discounted price is displayed directly in the shop (product list/detail page). The discount will NOT appear in the shopping cart summary. <span class="userinput_or_code">1</span> - The discount is only shown in the shopping cart.',
    ...
    'HELP_ALTERNATIVE_IMAGE_SERVER_NOTE' => 'Alternative URL to remote image server. All product pictures will be loaded from this alternative server instead of the local one. However, uploaded files will be stored locally. In this case synchronization to external server has to be done manually or with custom scripts.',
