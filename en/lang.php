...
$aLang = [
    ...
    'ARTICLE_ATTRIBUTE_OPENINNEWWINDOW' => 'Create new attribute',
    ...
    'ERR_MEDIA_MIME_BASETYPE_MISMATCH' => 'MIME type "%s" does not match the required base type "%s".',
    'ERR_MEDIA_MIME_GUESS_FAILED' => 'Invalid MIME type.',
    'ERR_MEDIA_MIME_GUESS_MISMATCH' => 'Detected MIME type "%s" does not match the client-provided type "%s".',
    'ERR_MEDIA_SIZE_TOO_SMALL' => 'The file size (%s) is smaller than the minimum allowed (%s).',
    'ERR_MEDIA_SIZE_TOO_LARGE' => 'The file size (%s) exceeds the maximum allowed (%s).',
    'ERR_MEDIA_EXTENSION_MISMATCH' => 'The file extension "%s" is not permitted for the detected MIME type. Allowed extensions: %s.',
    ...
    'ARTICLE_EXTEND_BPRICE' => 'Wholesale Price',
    ...
    'ARTICLE_PICTURES_ACTIVE' => 'Active',
    'ARTICLE_PICTURES_INACTIVE' => 'Inactive',
    'ARTICLE_PICTURES_DELETE' => 'Delete',
    'ARTICLE_PICTURES_MISSING' => 'No image available',
    'ARTICLE_PICTURES_ERROR_CLOSE' => 'Close error message',
    'PICTURE_ALT_TITLE' => 'Image Alt Attributes',
    'HELP_PICTURE_ALT' => 'Alt texts describe the image content for search engines and screen readers. Click any image row to edit alt text for all languages.',
    'PICTURE_ALT_COL_IMAGE' => 'Image',
    'PICTURE_ALT_COL_NAME_TYPE' => 'Name / Type',
    'PICTURE_ALT_COL_LANGUAGES' => 'Languages',
    'PICTURE_ALT_LEGEND_SAVED' => 'Saved',
    'PICTURE_ALT_LEGEND_UNSAVED' => 'Unsaved',
    'PICTURE_ALT_LEGEND_MISSING' => 'Missing',
    'PICTURE_ALT_NO_IMAGES' => 'No images found for this product.',
    'PICTURE_ALT_NO_LOCALES' => 'No locales are configured for this shop.',
    ...
    'EXCEPTION_FILEUPLOADERROR_1' => 'The uploaded file exceeds maximum allowed size (%s).', // UPLOAD_ERR_INI_SIZE
    'EXCEPTION_FILEUPLOADERROR_2' => 'The uploaded file exceeds the MAX_FILE_SIZE directive specified in the HTML form.', // UPLOAD_ERR_FORM_SIZE
    'EXCEPTION_FILEUPLOADERROR_3' => 'The file was only partially uploaded.', // UPLOAD_ERR_PARTIAL
    'EXCEPTION_FILEUPLOADERROR_4' => 'No file was uploaded.', // UPLOAD_ERR_NO_FILE
    'EXCEPTION_FILEUPLOADERROR_6' => 'Missing a temporary folder.', // UPLOAD_ERR_NO_TMP_DIR
    'EXCEPTION_FILEUPLOADERROR_7' => 'Failed to write file to disk.', // UPLOAD_ERR_CANT_WRITE
    'EXCEPTION_FILEUPLOADERROR_8' => 'File upload stopped by extension.', // UPLOAD_ERR_EXTENSION
    ...
    'EXCEPTION_THEME_INHERITANCE_INVALID' => 'Theme is not compatible with its parent theme',
    ...
    'THEME_SETTING_ENVIRONMENT_OVERRIDDEN_HINT' => 'This value is overridden by the environment configuration and can only be changed there.',
    'THEME_SETTING_ENVIRONMENT_OVERRIDDEN_ERROR' => 'The settings could not be saved because they are overridden by the environment configuration.',
    'MODULE_ID' => 'Module ID',
    ...
    'LANGUAGE_LOCALE_USE_SHOP_DEFAULT' => 'Use shop default',
    'HELP_LANGUAGE_LOCALE' => 'Assign a locale to this language (e.g. de_DE, en_GB).',
    'LOCALE_MANAGER_TITLE' => 'Locales',
    'LOCALE_CODE' => 'Code',
    'LOCALE_NAME' => 'Name',
    'LOCALE_FALLBACK' => 'Fallback',
    'LOCALE_ADD' => 'Add locale',
    'LOCALE_NO_LOCALES' => 'No locales configured.',
    'LOCALE_ACTIVE' => 'Active',
    'LOCALE_CODE_ALREADY_EXISTS' => 'A locale with this code already exists.',
    'HELP_LOCALES' => 'Define which locales are available for the current shop.',
    ...
    'TOOLTIPS_ARTICLEUNITDESCRIPTION' => 'The unit price is defined as the cost that applies<br> to a specific unit of measure, which includes<br> the sales tax and any other price components.',
    ...
    'tbclarticle_picture_alt' => 'Alt Texts',
