...
$aLang = [
    ...
    'HELP_DISCOUNT_MAIN_AMOUNT' => 'Mit <span class="navipath_or_inputname">Einkaufsmenge</span> können Sie einstellen, dass der Rabatt nur für bestimmte Einkaufsmengen gültig ist. Wenn Sie möchten, dass der Rabatt für alle Einkaufsmengen gültig ist, dann geben Sie in <span class="navipath_or_inputname">von</span> und in <span class="navipath_or_inputname">bis</span> <span class="userinput_or_code">0</span> ein. <br><br>Der Wert in <span class="navipath_or_inputname">von</span> steuert auch, wo der Rabatt angezeigt wird: <span class="userinput_or_code">0</span> - Der rabattierte Preis wird direkt im Shop (Artikelliste/Detailseite) angezeigt. Der Rabatt wird NICHT in der Warenkorb-Zusammenfassung angezeigt. <span class="userinput_or_code">1</span> - Der Rabatt wird nur im Warenkorb angezeigt.',
    ...
    'HELP_ALTERNATIVE_IMAGE_SERVER_NOTE' => 'In der Konfiguration kann eine URL zu einem externen Bilder-Server gesetzt werden. Dadurch werden alle Artikelbilder von diesem alternativen Server geladen. Alle hochgeladenen Dateien werden jedoch lokal gespeichert, so dass sie manuell oder per Script mit dem externen Server synchronisiert werden müssen.',
